<template>
    <div class="container grid grid-cols-2 place-items-center gap-5 py-32">
        <div class="flex flex-col gap-6 py-20">
            <h1 class="text-black text-4xl">Modern, online, free <span class="text-green-500">chat</span> 
            and <br/> <span class="text-green-500">contact</span> app</h1>
            <p class="text-gray-500 text-lg mb-3">Maecenas sed ligula ut dui pharetra aliquet. Vestibulum eget orci <br/> libero. 
            Sed est sem, mollis nec lectus nec, varius suscipit ligula. </p>
        ...
        <div class="container bg-green-500 grid grid-cols-2 gap-3 rounded-2xl top-0 right-0">
