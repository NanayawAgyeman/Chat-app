<template>
    <div class="container  py-20 flex flex-col items-center space-y-10">
        <div>
          <h2 class="text-4xl text-title text-center mb-3">Download App</h2>
          <p class="text-xl text-para text-center">Fusce placerat pretium mauris, vel sollicitudin elit <br/> lacinia 
          vitae. Quisque sit amet nisi erat.</p>
        </div>
       
        <div class="flex items-center space-x-2">
          <button class="p-2 text-white bg-solid w-40 rounded-full flex flex-row space-x-2">
